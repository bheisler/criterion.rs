...
<div align="center">
	<a href="https://japaric.github.io/Criterion.<span></span>rs/book/getting_started.html">Getting Started</a>
    |
    <a href="https://japaric.github.io/Criterion.<span></span>rs/book/index.html">User Guide</a>
    |
    <a href="https://japaric.github.io/Criterion.<span></span>rs/criterion/">API Documentation</a>	
</div>

<div align="center">
	<a href="https://travis-ci.org/japaric/Criterion.<span></span>rs">
    	<img src="https://travis-ci.org/japaric/Criterion.<span></span>rs.svg?branch=master" alt="Travis-CI">
    </a>
    |
...
```toml
    [dev-dependencies]
    criterion = { git = "https://github.com/japaric/Criterion.<span></span>rs.git" }
```
...
See the [Getting Started](https://japaric.github.io/Criterion.<span></span>rs/book/getting_started.html) guide for more details.
